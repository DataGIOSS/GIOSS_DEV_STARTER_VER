        ...
        while($data = fgetcsv($this->handle, 10000, "|")) {
          ...
          if(!$isValidRow){
            ...
            if($exists){
              ...
              $consult->validez_registro = $data[17];
              $consult->cod_diagnostico = $data[18];
              $consult->tipo_estudio = $data[20];
              $consult->motivo_no_diagnostico = $data[21];
              $consult->fecha_diagnostico = strtotime($data[22]);
              $consult->fecha_primera_consulta = strtotime($data[23]);
              $consult->histologia = $data[24];
              $consult->grado_diferenciacion = $data[25];
              $consult->primera_estadificacion = $data[26];
              $consult->fecha_estadificacion = strtotime($data[27]);
              $consult->resultado_prueba_her2 = $data[28];
              $consult->estadificacion_dukes = $data[29];
              $consult->estadificacion_dukes = $data[29];
              $consult->fecha_estadificacion_dukes = strtotime($data[30]);
              $consult->estadificacion_clinica = $data[31];
              $consult->valor_escala_gleason = $data[32];
              $consult->clasificacion_riesgo = $data[33];
              $consult->fecha_clasificacion_riesgo = strtotime($data[34]);
              $consult->objetivo_tratamiento = $data[35];
              $consult->objetivo_intervencion = $data[36];
              $consult->antecedentes_cancer_primario = $data[37];
              $consult->fecha_diagnostico_cancer_primario = strtotime($data[38]);
              $consult->cod_diagnostico_cancer_primario = $data[39];
              $consult->recibio_quimioterapia = $data[40];
              $consult->cantidad_fases_quimioterapia = $data[41];
              $consult->recibio_prefase_citorreduccion = $data[42];
              $consult->recibio_induccion = $data[43];
              $consult->recibio_intensificacion = $data[44];
              $consult->recibio_consolidacion = $data[45];
              $consult->recibio_reinduccion = $data[46];
              $consult->recibio_mantenimiento = $data[47];
              $consult->recibio_mantenimiento_largo_final = $data[48];
              $consult->recibio_quimioterapia_diferente = $data[49];
              $consult->sometido_a_cirugia = $data[50];
              $consult->ubicacion_temp_primera_cirugia = $data[51];
              $consult->motivo_ultima_cirugia = $data[52];
              $consult->ubicacion_temp_ultima_cirugia = $data[53];
              $consult->estado_final_ult_cirugia = $data[54];
              $consult->caracteristicas_actuales_prim_radio = $data[55];
              $consult->motivo_finalizacion_prim_radio = $data[56];
              $consult->ubicacion_temp_ult_radio = $data[57];
              $consult->tipo_radioterapia = $data[58];
              $consult->caracteristicas_actuales_ult_radio = $data[59];
              $consult->motivo_finalizacion_ult_radio = $data[60];
              $consult->recibio_transplante = $data[61];
              $consult->tipo_transplante = $data[62];
              $consult->ubicacion_temp_transplante = $data[63];
              $consult->fecha_transplante = strtotime($data[64]);
              $consult->usuario_recibio_valoracion = $data[65];
              $consult->recibio_consulta_espe_paliativo = $data[66];
              $consult->recibio_consulta_prof_salud = $data[67];
              $consult->recibio_consulta_otro_espe = $data[68];
              $consult->recibio_consulta_medico_general = $data[69];
              $consult->recibio_consulta_trabajador_social = $data[70];
              $consult->recibio_consulta_otro_prof_salud = $data[71];
